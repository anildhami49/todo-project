...
## ≡ƒÜÇ Quick Start - Local Development
...
## ≡ƒöä Automatic Deployment Setup
...
Add these secrets to your GitHub repository (Settings ΓåÆ Secrets and variables ΓåÆ Actions):
...
5. **Add Application Settings** (Configuration ΓåÆ Application settings):
...
## ≡ƒöä How Automatic Deployment Works
...
4. **Azure Web App detects** new image:
   ...
   - Your changes are LIVE! ≡ƒÄë

## ≡ƒôè Monitoring and Logs
...
# Go to Web App ΓåÆ Monitoring ΓåÆ Log stream
```
